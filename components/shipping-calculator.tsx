...
export default function ShippingCalculator({ productWeight = 1, productPrice = 0 }: ShippingCalculatorProps) {
  ...
  const calculateShipping = async () => {
    ...
    try {
      ...
      const isSoutheast = ["01", "02", "03", "04", "05", "08", "09"].includes(cleanCep.substring(0, 2))
      ...
      <CardContent className="space-y-4">
        <div className="flex gap-2">
          <div className="flex-1">
            ...
            />
            {error && (
              <p id="cep-error" className="text-sm text-red-500 mt-1" role="alert" aria-live="assertive">
                {error}
              </p>
            )}
          </div>
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    {option.price === 0 && <Badge className="bg-green-500">GRÁTIS</Badge>}
                  </div>
